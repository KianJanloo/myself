            ...
            <div className="p-8 pb-0">
              <div className="flex items-center justify-between">
                ...
                >
                  ...
                  <span className="hidden sm:inline">{t('resume.downloadPdf')}</span>
                  <span className="sm:hidden">{t('resume.downloadPdf')}</span>
                </motion.a>
              </div>
            </div>
            ...
            <div className="px-8 pb-8">
              <div className="grid grid-cols-3 gap-4 pt-6 border-t border-white/10">
                <div className="text-center">
                  ...
                  <div className="text-sm text-text-muted">{t('resume.yearsExperience')}</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold gradient-text">50+</div>
                  <div className="text-sm text-text-muted">{t('resume.projectsCompleted')}</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold gradient-text">10+</div>
                  <div className="text-sm text-text-muted">{t('resume.technologies')}</div>
                </div>
              </div>
            </div>
          </div>
