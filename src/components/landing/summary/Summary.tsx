...
const Summary = () => {
    return (
        <section id="summary" className="min-h-screen flex items-center justify-center py-20">
                        ...
                        <div className="space-y-6">
                            ...
                            >
                                <p className="text-xl text-text-primary font-medium leading-relaxed">
                                    Passionate about crafting seamless digital experiences with{" "}
                                    <span className="gradient-text font-bold">React</span> &{" "}
                                    <span className="gradient-text font-bold">Next.js</span>.
                                </p>
                                
                                <p className="text-lg text-text-muted leading-relaxed">
                                    With over 3 years of hands-on experience, I specialize in building modern, 
                                    responsive, and user-centric web applications. My focus is on performance, 
                                    accessibility, and delivering pixel-perfect interfaces that delight users 
                                    and drive business results.
                                </p>
                                
                                <p className="text-lg text-text-muted leading-relaxed">
                                    Always eager to learn new technologies, tackle challenging problems, 
                                    and collaborate with creative teams to turn ideas into reality.
                                </p>
                            </motion.div>
